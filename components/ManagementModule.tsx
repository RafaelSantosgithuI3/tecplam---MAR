    ...
    return (
        <div className="space-y-6">
            <header className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Gestão {tab === 'LINES' ? 'de Linhas' : 'de Cargos'}</h1>
            </header>

            <div className="flex gap-2 bg-slate-100 dark:bg-zinc-900 p-2 rounded-xl w-fit mb-6">
            ...
            <Card className="bg-white dark:bg-zinc-900 border-slate-200 dark:border-zinc-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {list.map((item) => (
                        <div key={item.id} className="bg-slate-50 dark:bg-zinc-950 p-3 rounded-lg flex justify-between items-center border border-slate-200 dark:border-zinc-900">
